document.addEventListener("DOMContentLoaded", function () {
    document.querySelectorAll(".yt-lazy-container").forEach(function (videoContainer) {
        ...
        // Set rel=0 for business owner videos, and disable related videos for media videos
        const relValue = isBusinessOwnerVideo ? "0" : "0"; // rel=0 for both, but media videos need extra prevention
        const extraParams = isBusinessOwnerVideo ? "" : "&modestbranding=1&controls=1&showinfo=0&fs=0&iv_load_policy=3&disablekb=1&playlist=" + videoId;
